...
void start_add_matrix(Matrix<int>& matrix_1, int N1, int M1) {
    system("cls");
...
void start_sub_matrix(Matrix<int>& matrix_1, int N1, int M1) {
    system("cls");
...
void start_mult_matrix(Matrix<int>& matrix_1, int N1, int M1) {
    system("cls");
